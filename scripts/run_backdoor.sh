...
python attack\\refactor_attack.py --src_jsonl test_dir\\output_refactors\\test.jsonl --dest_jsonl test_dir\\test_defense\\test.$TYPE.jsonl --target "This function is to load train data from the disk safely" --rate $RATE --refactor_type $TYPE
